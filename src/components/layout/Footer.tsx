...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-slate-700/50 bg-slate-900/30 backdrop-blur-xl supports-[backdrop-filter]:bg-slate-900/20 shadow-lg shadow-purple-500/10">
